...
public class StatModifier {
	...
	public String summary() {
		if (hasMods()) {
			return String.format("+[%s/%s/%s/%s/%s]", atk, def, spcAtk, spcDef,
					spe);
		} else {
			return "";
		}
	...
	public StatModifier combineWith(StatModifier other) {
		incrementAtkStage(other.getAtkStage());
		incrementDefStage(other.getDefStage());
		incrementSpcAtkStage(other.getSpcAtkStage());
		incrementSpcDefStage(other.getSpcDefStage());
		incrementSpeStage(other.getSpeStage());
		return this;
	}
